...
Assuming you have installed the "opentree" folder into your Google Refine extensions directory, execute "ant" from there and the extension will be recompiled and repackaged. You will need to restart oogle Refine for any changes to take affect.

h2. Credits

The refine-opentree extension was developed as part of the TreeForAll hackathon, Sept 15-19th 2014, supported by OpenTreeOfLife, Arbor and NESCent HIP.  
